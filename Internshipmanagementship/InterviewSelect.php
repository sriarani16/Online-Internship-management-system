...
<!--                        <span class="small grey">Last Login: 3 hours ago</span>-->
        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <?php 
				 $query=mysql_query("select * from interview  WHERE active=0 and company='".$comid."'")or die(mysql_error());
	$x=0;
...
<td align="center" width="20%"> <input type="submit" value="Send" /> </form> </div>
<div>

...
<!--                 <ul>
        ...
        <div class="grid_10">
           <div class="box round first grid">
                ...
                <div class="block">
                    ...
                    <form action="selectingstudent.php" method="post"> 
	...
	$select=$row['selection'];
					...
					echo'<tr'; if ($select==1){ echo' style=" background-color:#CFF;"'; } echo '>
							<td> <div id="popup"><a title="'.$fname.'"><span><img src="'.$image.'" style="width:120px; height:150px;" alt="Little Egret"></span>'.$fname.'</a></div></td>
							<td><h6>'.$phone.'</h6></td>
							<td><h6>'.$interview.'</h6></td>
							<td class="center"><h6> <a href="'.$cv.'" target="_blank">  View CV </h6></td>
							<td class="center"><h6> <a href="viewstudentdetails.php?id='.$id.'">  View Details </h6></td>
						</tr>';

...
<!--                 <ul>
        ...
        <div class="grid_10">
            <div class="box round first">
                   <h2><span style="color:#00C"><a href="AdminViewInterview.php">Change : Company</a></span></h2>
                    <div class="block">
                      <?php 
			
			
				 $query=mysql_query("select * from interview  WHERE selection=0 and active=1 ORDER BY intdate")or die(mysql_error());
	$x=0;

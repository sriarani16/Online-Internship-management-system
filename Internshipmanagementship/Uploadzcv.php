        ...
        <div class="grid_10">
            <div class="box round first">
                    ...
                    <div class="block">
                              ...
                              <form action="upcv.php" method="POST" enctype="multipart/form-data">
                  <table style="margin: 0px auto;">  
        
<div class="rowElem"><td><label>CV  :</label></td><td><input type="file" name="filename"accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword" /></div></td></tr>

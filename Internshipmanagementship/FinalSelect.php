...
<!--  <form action="Addingstaff.php" method="post">             -->
                
                <?php 
				 $query=mysql_query("select * from interview  WHERE selection=0 and active=2 and company='".$comid."'")or die(mysql_error());
	$x=0;
	 while($row=mysql_fetch_array($query)){
		 $id=$row['im_no'];
		 
		  $sql_l="SELECT * FROM selection WHERE im_no='".$id."' and company='".$userid."'";
		 ...
		 $sql_stu="SELECT * FROM student WHERE  im_no='".$id."'";
			  ...
			  $imagestu=$row_stu['image'];
                 ...
                 echo' <div id="div'.$x.'" class="message info">   <table style="margin-top:15px;" class="form"  width="100%">
						  ...
						  <td align="center"><img src="'.$imagestu.'" style="border:#000 solid 2px;width:80px; height:100px;" alt="Little Egret"></td>
                               <td style=" vertical-align:middle" align="center" width="20%" ><div id="popup"><h5><a href="example.jpg" rel="lightbox" title="'.$f_name.'"><span></span>'.$f_name.'</a></h5></div></td>
                               <td style=" vertical-align:middle"align="center" width="20%"><h5><a href="'.$cv.'" target="_blank"
							   >  View CV </h5></a></td>
                            
                               <td style=" vertical-align:middle"align="center"width="20%"><h5>Total Marks: '.$mark.' </h5></td>
                               
 
<td align="center" width="20%" style=" vertical-align:middle"> <input type="checkbox" value="'.$id.'" name="staff[]" /></form> </div>
<div>
           ...
           <input type="submit" value="Select" style="float:right ; margin-right:20px; " />    
           <br />
<br />

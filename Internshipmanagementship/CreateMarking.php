...
<!--                        <span class="small grey">Last Login: 3 hours ago</span>-->
        ...
        <div class="grid_10">
			...
			<form action="Addindmarkingscheme.php" method="post">
	 
             <div id="div'.$x.'" class="message success">   <table  			style="margin-top:15px;" class="form"  width="100%">
             <tr><th style="text-align:left">Category</th><th>Marks</th><th></th></tr>
                               <tr ><td width="50%">
                               <textarea style="width:400px; height:50px;" name="cat">
                               </textarea>
                                </td>
...
echo'<table style="margin-top:15px;" class="form"  width="100%">
             <tr style="background-color:#FFF;"><th style="text-align:left" width="50%" ><h5>Category</th><th>Marks</h5></th><th></th></tr>';
	 $x=0;
	 while($row=mysql_fetch_array($query)){
      ...
      <h4>'.$marks.'</h4>
                        ...
                        </tr> <tr style="height:2px;background-color:#FFF; "><th> </th><th> </th><th> </th></tr> <input type="text" name="id" value="'.$id.'" hidden="hidden">
                             </form> ';
		 ...
		 $x=$marks+$x;
			 ...
			 echo '  </table><h2 style="float:right">Total : '.$x.'</h2> 
			 <br />
